...
<img class="icon" src="<%=request.getContextPath() %>/dba/Images/logo.png" alt="-">
</td>
</tr>
</table>
<center style="text-align: center;"><%=t%></center>
 <form action="<%=request.getContextPath() %>/dba/Main.jsp" method="post" name="login" onSubmit="return validate(this)" target="_top"> 
