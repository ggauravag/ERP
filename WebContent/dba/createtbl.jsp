...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/dba/default.css">
         ...
         //       columnnm=rsmd.getColumnName(i).toString();
          //      rsmd.getColumnTypeName(i);
            //    rsmd.getColumnDisplaySize(i);
                ...
                <br>
  				<form action="<%=request.getContextPath() %>/dba/tabledata.jsp?db=<%=db %>&table=<%=newtblname %>&newtblfields=<%=rsmd.getColumnCount() %>" method="post">
