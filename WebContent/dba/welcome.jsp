...
<body bgcolor="#f5f5f5">
<form action="<%=request.getContextPath() %>/dba/createdb.jsp?mknewdb=<%=i %>" method="post" name="newdbname" onSubmit="return validate(this)"> 
...
<input type="submit" value="Create" name="create"><br><br><br> 
 ...
 <img class="icon" src="<%=request.getContextPath() %>/dba/Images/arrow.png" alt="-" width="5" height="9" ><a href="createuser.jsp"  >Create User</a>
  <br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;
 <img class="icon" src="<%=request.getContextPath() %>/dba/Images/arrow.png" alt="-" width="5" height="9" ><a href="tabledata.jsp?server=localhost&db=mysql&table=user"><span>Privileges</span></a>
