...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="ManageCustomer.do" 
					method="post" id="manageCusForm" name="manageCusForm" role="form">

			<div class="card">
				<div class="card-header">
					<h2>Enter Name or Mobile and manage the details</h2>
				</div>
				...
				<div class="card-body card-padding">
					<div class="form-group" id="nameDiv">
						...
						<div class="col-sm-8">
							<div class="fg-line">
								<input type="text" class="form-control" id="inputName" name="inputName" value="" readonly>
							</div>
							<span class="md md-person form-control-feedback"></span>
					...
					<div class="row">
						...
						<div class="form-input" style="display: none;" id="forTin">
							<label for="inputTin" class="col-sm-1 control-label">Tin No</label>
					...
					<div class="row">
						<div id="cityDiv" class="form-input">
							...
							<div class="col-sm-3 m-b-25">
								<select class="form-control" id="inputCity" name="custCity" disabled>
						...
						<div id="stateDiv" class="form-input">
							<div class="col-sm-3 m-b-25">
								<select class="form-control" id="inputState" name="custState" disabled>
	...
	<jspcore:if test="${custStatus == 'Updated'}">
		<script>
			swal("Successful !", "Customer Details updated successfully", "success");
		</script>
	</jspcore:if>		
	<jspcore:if test="${custStatus == 'notUpdated'}">
		<script>
			swal("Error Occurred !", "Unable to update customer details now, try again.", "error");
		</script>
	</jspcore:if>
	...
	<jspcore:if test="${custStatus == 'notDeleted'}">
		<script>
			swal("Error Occurred !", "Unable to delete customer now, try again.", "error");
		</script>
	</jspcore:if>				
