				...
				<div class="si-inner">
					<div class="profile-menu">
						...
						<ul class="main-menu">
							...
							<li><a href="#"><i class="md md-settings"></i> Settings</a>
							</li>
							<li><a href="./logout.do"><i class="md md-history"></i> Logout</a></li>
						</ul>
					</div>
					...
					<ul class="main-menu">
						...
						<li class="sub-menu"><a href="#"><i class="md-group"></i>
								Employee</a>
							<ul>
