...
<header id="header">
		<ul class="header-inner">
			...
			<li class="logo hidden-xs"><a href="index-2.html"><bean:message key="enterprise.label" /></a></li>
			...
			<li class="pull-right">
				<ul class="top-menu">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						class="tm-message" href="#"><i class="tmn-counts">6</i></a>
							...
							<div class="listview">
								...
								<div class="lv-body c-overflow">
									<a class="lv-item" href="#">
										<div class="media">
											<div class="pull-left">
												<img class="lv-img-sm" src="<%=request.getContextPath() %>/img/profile-pics/mypic.jpg"
													alt="">
											</div>
										...
										<div class="media">
											<div class="pull-left">
												<img class="lv-img-sm" src="<%=request.getContextPath() %>/img/profile-pics/2.jpg" alt="">
											</div>
											<div class="media-body">
										...
										<div class="media">
											<div class="pull-left">
												<img class="lv-img-sm" src="<%=request.getContextPath() %>/img/profile-pics/3.jpg" alt="">
											</div>
											<div class="media-body">
										...
										<div class="media">
											<div class="pull-left">
												<img class="lv-img-sm" src="<%=request.getContextPath() %>/img/profile-pics/4.jpg" alt="">
											</div>
											<div class="media-body">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						class="tm-notification" href="#"><i class="tmn-counts">9</i></a>
						<div class="dropdown-menu dropdown-menu-lg pull-right">
								...
								<div class="lv-header">
									...
									<ul class="actions">
										<li class="dropdown"><a href="#"
											data-clear="notification"> <i class="md md-done-all"></i>
										</a></li>
									</ul>
								</div>
								<div class="lv-body c-overflow">
									<a class="lv-item" href="#">
										<div class="media">
											<div class="pull-left">
												<img class="lv-img-sm" src="<%=request.getContextPath() %>/img/profile-pics/1.jpg" alt="">
											</div>
											<div class="media-body">
												<div class="lv-title">David Belle</div>
												<small class="lv-small">Cum sociis natoque penatibus
					...
					<li class="dropdown hidden-xs"><a data-toggle="dropdown"
						class="tm-task" href="#"><i class="tmn-counts">2</i></a>
					...
					<li class="dropdown"><a data-toggle="dropdown"
						...
						<ul class="dropdown-menu dm-icon pull-right">
							...
							<li><a href="#"><i class="md md-person"></i> Privacy
									Settings</a></li>
