...
<header id="header">
	<ul class="header-inner">
		...
		<li class="logo hidden-xs"><a href="index-2.html"><bean:message
							...
							<div class="lv-body c-overflow">
								<a class="lv-item" href="#">
									<div class="media">
										<div class="pull-left">
											<img class="lv-img-sm"
												src="<%=request.getContextPath()%>/img/profile-pics/mypic.jpg"
												alt="">
										</div>
									...
									<div class="media">
										<div class="pull-left">
											<img class="lv-img-sm"
												src="<%=request.getContextPath()%>/img/profile-pics/2.jpg"
												alt="">
										</div>
										<div class="media-body">
									...
									<div class="media">
										<div class="pull-left">
											<img class="lv-img-sm"
												src="<%=request.getContextPath()%>/img/profile-pics/3.jpg"
												alt="">
										</div>
										<div class="media-body">
									...
									<div class="media">
										<div class="pull-left">
											<img class="lv-img-sm"
												src="<%=request.getContextPath()%>/img/profile-pics/4.jpg"
												alt="">
										</div>
										<div class="media-body">
							...
							<div class="lv-body c-overflow">
								<a class="lv-item" href="#">
									<div class="media">
										<div class="pull-left">
											<img class="lv-img-sm"
												src="<%=request.getContextPath()%>/img/profile-pics/1.jpg"
												alt="">
										</div>
										<div class="media-body">
											<div class="lv-title">David Belle</div>
