...
<% 	
	...
	if(empty(params.get("txnid"))){
		...
		String rndm = Integer.toString(201545);
		txnid=hashCal("SHA-256",rndm);
	}
	else
...
<input type="hidden" name="key" value="<%= merchant_key %>" />
      ...
      <table>
        ...
        <div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/C0322B3A5DEFF992366031C269F567BC"><img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/232.png" /></a></div>
      </table>
    </form>
